...
export default function LoginPage() {
  ...
  const performGoogleLogin = async (targetEmail, targetName = 'Suvan Senthil') => {
    setError('');
    setLoading(true);
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4 z-50 animate-fade-in">
          <div className="bg-white w-full max-w-sm rounded-2xl shadow-2xl overflow-hidden border border-gray-100">
            ...
            <div className="p-6 border-b border-gray-100 text-center relative">
              ...
              <h3 className="font-bold text-lg text-gray-800">Sign in with Google</h3>
              <p className="text-xs text-gray-500 mt-1">Choose an account to continue to LexAid</p>
            </div>

            {/* Account List */}
            <div className="p-4 space-y-2">
              <button
                onClick={() => performGoogleLogin('suvansenthils@gmail.com', 'Suvan Senthil')}
                className="w-full p-3 rounded-xl border border-gray-200 hover:bg-gray-50 transition-all flex items-center gap-3 text-left"
              >
                <div className="w-10 h-10 rounded-full bg-navy text-white font-bold flex items-center justify-center text-sm">
                  S
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-bold text-gray-800">Suvan Senthil</p>
                  <p className="text-xs text-gray-500 truncate">suvansenthils@gmail.com</p>
                </div>
                <span className="text-xs px-2 py-0.5 bg-accent/10 text-accent font-semibold rounded-md">Advocate</span>
              </button>

              <button
                onClick={() => performGoogleLogin('suvansenthils4175.sse@saveetha.com', 'Suvan Senthil')}
                className="w-full p-3 rounded-xl border border-gray-200 hover:bg-gray-50 transition-all flex items-center gap-3 text-left"
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-bold text-gray-800">Suvan Senthil (Saveetha)</p>
                  <p className="text-xs text-gray-500 truncate">suvansenthils4175.sse@saveetha.com</p>
                </div>
              </button>
            </div>
            ...
            <div className="p-4 bg-gray-50 border-t border-gray-100">
              <p className="text-xs font-semibold text-gray-600 mb-2">Use another Google Account:</p>
              <div className="flex gap-2">
                ...
                />
                <button
                  onClick={() => customGoogleEmail.trim() && performGoogleLogin(customGoogleEmail.trim(), customGoogleEmail.split('@')[0])}
                  disabled={!customGoogleEmail.trim()}
                  className="px-3 py-2 bg-navy text-white text-xs font-semibold rounded-lg hover:bg-navy-light disabled:opacity-50"
                >
                  Sign In
                </button>
              </div>

...
LEGAL_QA_CORPUS = [
    ...
    # ─── MOTOR VEHICLES ACT ───────────────────────────────────────────────────
    {"q": "bike crashed by government bus road accident vehicle collision hit mact compensation state bus accident what to do",
     "a": "⚖️ **Motor Vehicles Act, 1988 — Section 161, 163A & 166 (Government Transport Accident Claim)**\n\nIf your bike/vehicle was crashed or hit by a Government Transport Bus or any vehicle:\n\n**Immediate Actions Required:**\n1. **File an FIR** at the nearest police station under IPC Section 279 (Rash Driving) & Section 337/338 (Causing Hurt by Negligence).\n2. **Obtain Medical / Damage Evidence**: Get hospital treatment records, spot photos, and bike repair cost estimate.\n3. **File MACT Claim**: Submit a claim petition before the **Motor Accidents Claims Tribunal (MACT)**.\n\n**Compensation Entitlements:**\n• Full bike repair / total loss cost.\n• Medical bills + future treatment costs.\n• Loss of income & compensation for physical pain.\n• **Government Transport Undertakings & Insurance Companies** are strictly liable under law."},
